...
<body class="font-poppins">
  ...
  <main class="mx-auto max-w-5xl px-4 py-28">
    <h1 class="text-3xl font-semibold text-[#30442B]">Login (placeholder)</h1>
    <p class="mt-4 text-neutral-700">This is the login page placeholder. Implement PHP session-based auth when ready.
    </p>
  </main>
