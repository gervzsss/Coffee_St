...
<body class="min-h-screen bg-neutral-50 text-neutral-900 font-sans">
  ...
  <main class="mx-auto max-w-5xl px-4 py-32">
    ...
    <?php if (empty($orders)): ?>
      <div class="rounded-lg border bg-white p-6 shadow-sm"><p class="text-neutral-700">No orders yet.</p></div>
    <?php else: ?>
      <div class="rounded-lg border bg-white shadow-sm">
        <table class="w-full text-sm">
          <thead class="text-neutral-500 border-b">
            <tr><th class="text-left p-4">Order ID</th><th class="text-left p-4">Date</th><th class="text-right p-4">Total</th><th class="text-left p-4">Status</th><th class="p-4"></th></tr>
          </thead>
          <tbody>
