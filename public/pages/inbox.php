      ...
      <?php foreach ($threads as $thread): ?>
        ...
        <div class="mb-8 bg-white rounded-xl shadow p-6">
          ...
          <div class="mb-4 text-sm text-gray-500">
            <span class="mr-4">Opened: <?= $openedAt
              ? htmlspecialchars(date("Y-m-d h:i A", strtotime($openedAt)))
              : "—" ?></span>
            <span>Updated: <?= $updatedAt
              ? htmlspecialchars(date("Y-m-d h:i A", strtotime($updatedAt)))
              : "—" ?></span>
          </div>
          <div class="space-y-4">
