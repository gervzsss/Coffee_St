<?php
function renderAdminOrdersPage(array $orders): void
{
  ?>
  <div class="main-content min-h-screen p-6 ml-64 transition-all duration-300 ease-in-out"><!-- .main-content -->
    <div class="max-w-screen-2xl mx-auto"><!-- .container -->
      ...
      <!-- Orders List -->
      <div class="bg-white rounded-2xl shadow-sm transition-all duration-300 ease-in-out"><!-- .orders-wrapper -->
