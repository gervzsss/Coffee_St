...
function renderAdminContent()
{
  ...
  <div class="main-content min-h-screen p-6 ml-64 transition-all duration-300 ease-in-out">
        ...
        <div class="max-w-4xl mx-auto">
          <div class="bg-white/10 backdrop-blur-sm rounded-xl p-2 flex items-center justify-between gap-3">
            <button data-tab="customer"
              class="tab-button flex-1 px-8 py-4 bg-white text-[#30442B] rounded-lg shadow-sm hover:shadow-md transition-all">
              <span class="text-base font-bold uppercase tracking-wider">Customer Accounts (6)</span>
            </button>
            <button data-tab="staff"
              class="tab-button flex-1 px-8 py-4 text-white hover:bg-white/10 rounded-lg transition-all">
                  ...
                  <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                    <td class="py-4 pl-4">
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          <p class="font-medium text-gray-800"><?= $user[
                            "name"
                          ] ?></p>
                          <p class="text-gray-500 text-xs"><?= $user[
                            "phone"
                          ] ?></p>
                        </div>
                      </div>
                  ...
                  <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition-all duration-300">
                    <td class="py-4 pl-4">
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          <p class="font-medium text-gray-800"><?= $staff[
                            "name"
                          ] ?></p>
                          <p class="text-gray-500 text-xs"><?= $staff[
                            "phone"
                          ] ?></p>
                        </div>
                      </div>
                    ...
                    <td class="py-4">
                      <div class="flex items-center gap-2">
                        <button class="edit-staff p-2 hover:bg-[#30442B]/10 rounded-xl transition-all duration-300"
                          title="Edit Account" data-name="<?= $staff[
                            "name"
                          ] ?>" data-email="<?= $staff[
                             "email"
                           ] ?>" data-phone="<?= $staff[
        ...
        <div id="inquiriesContent" class="tab-content p-8" style="display: none;">
          ...
          <div class="grid gap-4">
            ...
            <div class="p-5 border border-gray-200 rounded-xl hover:shadow-md transition-all bg-white">
              ...
              <p class="text-gray-600 text-sm mb-3">What are your typical delivery times for orders placed in the morning?
                I need to plan my schedule</p>
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-500">2024-01-15 08:15 AM</span>
                <button
                  class="reply-inquiry px-5 py-2 text-sm font-medium text-white bg-[#30442B] hover:bg-[#3a5336] rounded-lg transition-all shadow-sm"
                  data-name="Jane Smith" data-email="jane@email.com" data-subject="Question about delivery times"
            ...
            <div class="p-5 border border-gray-200 rounded-xl hover:shadow-md transition-all bg-white">
              ...
              <p class="text-gray-600 text-sm mb-3">Do you offer discounts for bulk orders? We need coffee for our office
                of 50 people</p>
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-500">2024-01-14 02:30 PM</span>
                <button
                  class="reply-inquiry px-5 py-2 text-sm font-medium text-white bg-[#30442B] hover:bg-[#3a5336] rounded-lg transition-all shadow-sm"
                  data-name="Michael Brown" data-email="michael.b@email.com" data-subject="Bulk order inquiry"
            ...
            <div class="p-5 border border-gray-200 rounded-xl hover:shadow-md transition-all bg-white">
              ...
              <p class="text-gray-600 text-sm mb-3">Is the Ethiopian blend still available? I couldn't find it on the
                website</p>
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-500">2024-01-13 11:45 AM</span>
                <button
                  class="reply-inquiry px-5 py-2 text-sm font-medium text-white bg-[#30442B] hover:bg-[#3a5336] rounded-lg transition-all shadow-sm"
                  data-name="Emily Wilson" data-email="emily.w@email.com" data-subject="Product availability question"
    ...
    include_once __DIR__ .
      "/../../components/modals/admin-account-modals.php";
