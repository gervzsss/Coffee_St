...
<div class="bg-[#30442B] text-white rounded-2xl p-8 mb-8 max-w-screen-2xl mx-auto">
    <div class="flex justify-between items-start">
        <div>
            ...
            <p class="text-sm text-white/80 mt-2">Wednesday, October 15, 2025 — Welcome back to your coffee shop management dashboard</p>
        </div>
    </div>
</div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="h-64 bg-gradient-to-b from-white to-gray-50 rounded-lg flex items-end p-4">
                ...
                <svg viewBox="0 0 600 200" class="w-full h-full">
                    <polyline fill="none" stroke="#30442B" stroke-width="4" points="20,140 100,120 180,130 260,110 340,150 420,120 500,100" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        </div>
