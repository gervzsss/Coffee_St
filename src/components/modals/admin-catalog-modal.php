<!-- Add Product Modal -->
<div id="addProductModal" class="fixed inset-0 hidden z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
  aria-modal="true">
  <!-- Modal Backdrop -->
    ...
    <div
      ...
      <div class="relative px-6 pt-6">
        <div class="flex items-center justify-between">
          ...
          <button
            class="close-modal absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors duration-200 p-2 rounded-full hover:bg-gray-100">
      ...
      <div class="bg-gray-50 px-6 py-4 rounded-b-2xl flex justify-end gap-3">
        <button type="button"
          class="close-modal px-4 py-2 rounded-lg text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#30442B] transition-colors duration-200">
          Cancel
        </button>
        <button type="submit" form="addProductForm"
          class="px-4 py-2 rounded-lg bg-[#30442B] text-white hover:bg-[#22301e] focus:outline-none focus:ring-2 focus:ring-[#30442B] focus:ring-offset-2 transition-colors duration-200 flex items-center gap-2">
...
<!-- Edit Product Modal -->
<div id="editProductModal" class="fixed inset-0 hidden z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
  aria-modal="true">
  <div class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm transition-opacity duration-300 opacity-0"
  ...
  <div class="fixed inset-0 flex items-center justify-center p-4">
    <div
            ...
            <div class="flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 rounded-lg">
              <div class="space-y-1 text-center">
                ...
                <div class="flex text-sm text-gray-600">
                  <label
                    class="relative cursor-pointer bg-white rounded-md font-medium text-[#30442B] hover:text-[#22301e] focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#30442B]">
      ...
      <div class="bg-gray-50 px-6 py-4 rounded-b-2xl flex justify-end gap-3">
        <button type="button"
          class="close-edit-modal px-4 py-2 rounded-lg text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#30442B] transition-colors duration-200">
          Cancel
        </button>
        <button type="submit" form="editProductForm"
          class="px-4 py-2 rounded-lg bg-[#30442B] text-white hover:bg-[#22301e] focus:outline-none focus:ring-2 focus:ring-[#30442B] focus:ring-offset-2 transition-colors duration-200">
          Save Changes
        </button>
      </div>
    </div>
...
<div id="unavailableModal" class="fixed inset-0 hidden z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
  aria-modal="true">
  <div class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm transition-opacity duration-300 opacity-0"
  ...
  <div class="fixed inset-0 flex items-center justify-center p-4">
    <div
      ...
      <div class="bg-gray-50 px-6 py-4 rounded-b-2xl flex justify-end gap-3">
        <button type="button"
          class="close-unavailable-modal px-4 py-2 rounded-lg text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#30442B] transition-colors duration-200">
          Cancel
        </button>
...
<div id="historyModal" class="fixed inset-0 hidden z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
  aria-modal="true">
  <div class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm transition-opacity duration-300 opacity-0"
  ...
  <div class="fixed inset-0 flex items-center justify-center p-4">
    <div
      ...
      <div class="relative px-6 pt-6">
        ...
        <p class="mt-1 text-sm text-gray-500">Complete history and statistics for <span id="historyProductName"
      ...
      <div class="bg-gray-50 px-6 py-4 rounded-b-2xl flex justify-end">
        <button type="button"
          class="close-history-modal px-4 py-2 rounded-lg text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#30442B] transition-colors duration-200">
          Close
        </button>
      </div>
    </div>
