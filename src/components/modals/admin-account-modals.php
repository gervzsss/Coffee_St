    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-4">
      <div class="p-8">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-xl font-bold text-gray-800">User Details - <span id="modalUserName"
              class="text-[#30442B]"></span></h2>
  ...
  <div id="banConfirmModal" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm hidden items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
      <div class="p-6 text-center">
        ...
        <p class="text-gray-600 mb-6">Are you sure you want to block <span id="banUserName" class="font-medium"></span>?
        ...
        <form id="editStaffForm" class="space-y-4">
          <div>
            ...
            <input type="text" id="editFullName"
              class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#30442B]/20 focus:border-[#30442B] transition-all">
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <select id="editRole"
                class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#30442B]/20 focus:border-[#30442B] bg-white transition-all">
          ...
          <button type="submit"
            class="w-full px-6 py-3 bg-[#30442B] text-white rounded-xl hover:bg-[#3a5336] transition-all duration-300 font-medium shadow-lg hover:shadow-xl mt-6">
            Save Changes
          </button>
        </form>
      </div>
