  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-8 border-b border-white/10">
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-xl font-bold">
        ...
        {isOpen && admin && (
          <div className="flex flex-col">
            ...
            <span className="text-xs text-white/70 truncate">{admin.email}</span>
          </div>
        )}
      </div>
