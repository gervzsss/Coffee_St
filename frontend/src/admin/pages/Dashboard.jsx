    ...
    <AdminLayout>
      <div className="p-8">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-white/80 mt-2">
                {currentDate} — Welcome back to your coffee shop management dashboard
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 max-w-screen-2xl mx-auto">
          ...
          <p className="text-sm text-gray-600">Overview of system activity and quick insights</p>
        </div>
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Sales Overview</h3>
              <p className="text-sm text-gray-500 mb-6">Daily sales for the past week</p>
              <div className="h-64 bg-gradient-to-b from-white to-gray-50 rounded-lg flex items-end p-4">
            ...
            {/* Top Selling (bar) */}
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Top Selling</h3>
              <p className="text-sm text-gray-500 mb-6">Latest products trends this week</p>
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-sm text-gray-500 mb-6">Latest system events and updates</p>
            ...
            <ul className="space-y-6">
              {stats?.recentOrders && stats.recentOrders.length > 0 ? (
                ...
                <li className="border-l-2 border-[#30442B] pl-6 hover:border-l-4 transition-all duration-200">
                  ...
                  <div className="text-sm text-gray-500 mt-1">System is ready for new orders</div>
                </li>
              )}
            </ul>
          </div>
