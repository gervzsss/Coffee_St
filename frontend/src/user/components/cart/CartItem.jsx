          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            >
              <button
                ...
                className="h-8 w-8 rounded-full border border-neutral-200 flex items-center justify-center cursor-pointer text-lg leading-none text-[#30442B] hover:border-[#30442B] transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
              >
                -
              </button>
