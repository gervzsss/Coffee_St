...
export default function AboutHero() {
  return (
    <section className="relative isolate pt-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col gap-8 px-4 py-16 text-white sm:gap-10 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:max-w-6xl">
        <div>
          <span className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-[10px] font-semibold tracking-[0.35em] text-amber-200 uppercase sm:px-4 sm:text-xs">Our Story</span>
          <h1 className="font-outfit mt-4 text-3xl leading-tight font-semibold sm:mt-6 sm:text-4xl lg:text-5xl xl:text-6xl">
