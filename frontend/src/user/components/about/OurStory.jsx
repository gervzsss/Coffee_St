...
export default function OurStory() {
  return (
    <section className="relative -mt-8 overflow-hidden py-12 sm:-mt-10 sm:py-16 lg:-mt-12 lg:py-24">
        ...
        <div className="flex min-h-[400px] flex-col gap-8 sm:min-h-[500px] sm:gap-10 lg:min-h-[600px] lg:flex-row lg:gap-12">
          ...
          <div className="flex flex-1 items-center p-4 sm:p-6 lg:p-12">
            <div className="mx-auto max-w-xl transform transition-all duration-500 hover:translate-y-[-5px]">
              <span className="inline-block border-b-2 border-[#967259]/20 pb-2 text-xs font-semibold tracking-[0.3em] text-[#967259] uppercase sm:text-sm">Our Journey</span>
              <h2 className="font-outfit mt-4 bg-linear-to-r from-[#30442B] via-[#967259] to-[#30442B] bg-clip-text text-2xl font-semibold text-transparent sm:mt-6 sm:text-3xl lg:text-4xl">
                A Story of Passion & Quality
              </h2>
              <div className="mt-6 space-y-4 text-neutral-600 sm:mt-8 sm:space-y-6">
