      ...
      <div className="relative z-20 flex h-full items-center">
        <div className="mx-auto w-full max-w-2xl px-4 sm:px-6 md:ml-8 md:px-0 lg:ml-16 xl:ml-24 xl:max-w-3xl 2xl:ml-32 2xl:max-w-4xl">
          <motion.div className="text-left" variants={staggerContainer} initial="hidden" animate="visible">
            <motion.span
              className="font-poppins mb-4 inline-block rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs tracking-wide text-white uppercase backdrop-blur-sm sm:mb-6 sm:px-6 sm:py-2.5 sm:text-sm"
              variants={staggerItem}
            >
              Welcome to Coffee St.
            </motion.span>
            <motion.h1
              className="font-playfair mb-4 text-3xl leading-tight font-bold tracking-tight text-white sm:mb-6 sm:text-4xl md:text-5xl lg:mb-8 lg:text-6xl xl:text-7xl 2xl:text-8xl"
              variants={staggerItem}
            >
              Experience the
              <br />
            ...
            <motion.p
              className="font-poppins mb-6 max-w-md text-sm leading-relaxed tracking-wide text-white/90 sm:mb-8 sm:max-w-lg sm:text-base md:text-lg lg:mb-10 lg:max-w-xl lg:text-xl"
              variants={staggerItem}
            >
              Discover our carefully curated selection of premium coffee beans and artisanal brews, crafted just for you.
            </motion.p>
            <motion.div className="flex flex-col gap-3 sm:flex-row sm:gap-4 lg:gap-5" variants={staggerItem}>
              <Link
                to="/products"
